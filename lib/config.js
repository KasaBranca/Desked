...
const config = {
  ...
  // Audio: capture the default speakers via WASAPI loopback and stream Opus.
  audioEnabled: (process.env.AUDIO_ENABLED || '1') !== '0',
  audioBitrate: Math.min(320, Math.max(16, parseInt(process.env.AUDIO_BITRATE, 10) || 96)),
